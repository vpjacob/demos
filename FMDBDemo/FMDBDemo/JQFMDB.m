...
- (void)insertTableName:(NSString *)tableName alterFieldName:(NSString *)alterFieldName FieldType:(NSString *)FieldType{
    NSString *alertStr = [NSString stringWithFormat:@"ALTER TABLE %@ ADD %@ %@",tableName,alterFieldName,FieldType];
